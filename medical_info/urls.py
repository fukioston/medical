...
urlpatterns = [
    ...
    path('search_disease', info.search_disease),
    path('search_symptom', info.search_symptom),
    path('search_drug', info.search_drug),
    path('search_diagnose', info.search_diagnose),
